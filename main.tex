...
\begin{itemize}
\item \textit{Advanced:} HTML, CSS, Javascript
\item \textit{Experienced:} Haskell, LaTex, Bash, C, C++, Python
\item \textit{Basics:} C\#, .Net technologies, Java, Ruby, Standard ML, PHP
\end{itemize}
\bigskip

\item \textbf{Frameworks and tools:}\\
Bootstrap, JQuery, PureCSS, EasyRTC, NodeJS, Jekyll, Grunt, Sass and Bower.
\bigskip
...
\ifenglish
\section{EDUCATION}
\cventry{2015--}{Sprogcenter Aalborg}{Danish language course}{Aalborg}{}{Have passed exams Prøve i Dansk 1, Prøve i Dansk 2, and Prøve i Dansk 3. This last one I passed with an avarage of 8.5 in May 2016.}
...
\else
\section{UDDANNELSE}
\cventry{2015--}{Sprogcenter Aalborg}{Dansk kursus}{Aalborg}{}{Har bestået eksamen Prøve i Dansk 1, Prøve i Dansk 2 og Prøve i Dansk 3. Jeg beståede Prøve i Dansk 3 med karakter 8.5 i Maj 2016.}
